...
{
    ofVec3f alignment = ofVec3f(0,0,0); //boid::alignment(boids);
    ofVec3f cohesion = ofVec3f(0,0,0); // boid::cohesion(boids);
    ofVec3f seperation = ofVec3f(0,0,0);//boid::seperation(boids);
